...
- главный экран `Кабинеты` с уровнем `Клиент`, вкладкой Wildberries, добавлением портала через API или вручную и скрытой Ozon beta-вкладкой только для Дмитрия;
