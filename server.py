...
- описание должно быть лаконичным, правдивым и читабельным, без артикулов, доменов, лишнего перечисления цветов/размеров и чужих брендов;
...
def build_card_content_reoptimization(portal_id, card_key, raw_card, selected_keywords=None, current_keywords=None, remove_keywords=None, draft=None, characteristics_context=None):
  ...
  return {
    ...
    "contentOptimization": {
      ...
      "createdAt": utc_now().isoformat(),
      "engine": "opticards-semantic-content-v2",
      "provider": provider,
      "model": model,
