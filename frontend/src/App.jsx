        ...
        <div className={`detail-layout ${activeTab === "technical" ? "wide-changes" : ""}`}>
          ...
          <div className="detail-main">
            ...
            {activeTab === "competitors" ? (
              <OzonDetailPendingPanel
                title="Товарный аудит Ozon"
                copy="Вкладка оставлена в той же структуре, что и WB-карточка. Сравнение с конкурентами подключим на Ozon-данных без WB-аудита."
                tag="следующий слой"
              />
            ) : null}
